...
export const TRANSLATIONS: Translations = {
    ...
    userManagement: { pt: 'Gestão de Usuários', en: 'User Management' },
    serviceManagement: { pt: 'Gestão de Serviços', en: 'Service Management' },
    tvSettings: { pt: 'Painel TV & Anúncios', en: 'TV & Announcement Panel' },
